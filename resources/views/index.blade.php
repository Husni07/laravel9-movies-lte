...
<html lang="en" class="scroll-smooth">
    <head>
        ...
        <style>
            @layer components {
                .nav-link-item {
                    @apply py-3 font-normal text-stream-gray transition-all cursor-pointer lg:py- hover:text-white;
                }
            }
...
<body>
    <header class="text-white bg-stream-dark font-poppins select-none h-full relative">
        ...
        <nav class="container py-5 relative">
            <div class="flex flex-col w-full lg:flex-row lg:items-center">
                <div class="flex items-center justify-between block lg:hidden">
                    <a href="/index.html">
                        <img src="{{ asset('adminlte/dist/img/favicon.ico') }}" alt="stream">
                    </a>
                    <div>
                ...
                <div class="hidden w-full lg:block" id="navigation">
                    <div class="flex flex-col items-baseline lg:justify-between mt-6 lg:flex-row lg:items-center lg:mt-0">
                        ...
                        <div class="flex flex-col w-full font-normal lg:w-auto lg:gap-12 lg:items-center lg:flex-row">
                            <a href="{{ route('member.login')}}" class="px-8 py-3 mt-3 text-center outline outline-2 outline-stream-gray rounded-3xl lg:mt-0">
        ...
        <section class="py-[100px] flex flex-col items-center gap-5 px-3 relative">
            ...
            <a href="{{ route('member.register') }}" class="mt-5 rounded-full bg-indigo-600 text-center py-3 px-11">
                <span class="text-white font-semibold text-base">I'm Ready</span>
            </a>
        </section>
        <section class="px-4 relative max-w-[950px] overflow-hidden mx-auto">
            <div class="w-full relative flex">
                <img src="{{ asset('stream/assets/images/temp_img.png') }}" class="object-cover rounded-[50px]" alt="stream" />
                <button class="absolute z-10 top-[50%] left-[50%] -mt-[25px] -ml-[25px] md:-mt-[44px] md:-ml-[44px] cursor-pointer" id="stream-preview">
        ...
        <section class="relative">
            <div class="max-w-screen hidden h-full mx-auto bg-black bg-opacity-70 fixed z-30 inset-0" id="openStream"></div>
            <video-js class="frame-video overflow-hidden hidden fixed h-[405px] max-h-max max-w-full w-[720px] top-[25%] -translate-y-[25%] left-1/2 -translate-x-1/2 z-50" id="stream-video" controls preload="auto" poster="{{ asset('stream/assets/images/poster.png') }}" data-setup='{"disablePictureInPicture":true, "noUITitleAttributes":true}'>
        ...
        <!-- brand partner -->
        <section class="brands pb-[100px] pt-[50px] flex flex-wrap justify-center items-center gap-x-[70px] gap-y-10 px-2 relative">
    ...
    <script src="https://code.jquery.com/jquery-3.6.0.min.js" integrity="/xUj+30JU5yExlq6GSYGSHk7tPXikynS7ogEvDej/m4=" crossorigin="anonymous"></script>
