...
<body class="bg-stream-dark">
    <div class="relative">
        <div class="hidden lg:block fixed">
            <img src="https://images-wixmp-ed30a86b8c4ca887773594c2.wixmp.com/f/9cd4ae05-b435-4c68-9cc1-759db013d763/df4yd3l-975eb736-714f-4b3f-845d-e884c32c77b7.jpg?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..IZ9QscnjVKG-ihu_T5oLAyO4ScsQwxhPa2ndsYYSzvU" class="max-h-screen" alt="stream" />
        </div>
    </div>
                    ...
                    <section class="w-11/12 max-w-[460px">
                        <form action="{{ route('member.register.store') }}" method="POST"
                            ...
                            @error('password')
                                <div style="color:red">{{ $message }} </div>
                            @enderror
                            {{-- <a href="" class="bg-indigo-600 rounded-full py-3 mt-4 text-center"> <span
                                    class="font-semibold text-white text-base">Continue</span>
                            </a> --}}
                            <button type="submit" class="bg-indigo-600 rounded-full py-3 mt-4 text-center"> <span
                                    class="font-semibold text-white text-base">Continue</span>
                            </button>
                        </form>
                    </section>
